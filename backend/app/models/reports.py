...
class Report(db.Model):
    ...
    report_type = db.Column(Enum(ReportType), nullable=False, index=True)
    description = db.Column(db.Text)
    format = db.Column(Enum(ReportFormat), nullable=False, default=ReportFormat.PDF, index=True)
    status = db.Column(Enum(ReportStatus), default=ReportStatus.PENDING, nullable=False, index=True)
    schedule = db.Column(Enum(ReportSchedule), default=ReportSchedule.ON_DEMAND, nullable=False)
...
class ReportTemplate(db.Model):
    ...
    default_format = db.Column(Enum(ReportFormat), default=ReportFormat.PDF)
