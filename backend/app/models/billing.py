...
class Invoice(db.Model):
    ...
    status = db.Column(Enum(InvoiceStatus), default=InvoiceStatus.DRAFT, nullable=False, index=True)
...
class BillingLine(db.Model):
    ...
    category = db.Column(Enum(BillingCategory), nullable=False, index=True)
