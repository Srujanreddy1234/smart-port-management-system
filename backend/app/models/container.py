...
class Container(db.Model):
    ...
    container_type = db.Column(Enum(ContainerType, values_callable=lambda x: x.value), nullable=False, index=True)
    status = db.Column(Enum(ContainerStatus, values_callable=lambda x: x.value), default=ContainerStatus.EMPTY, nullable=False, index=True)
