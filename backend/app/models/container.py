...
class Container(db.Model):
    ...
    container_type = db.Column(Enum(ContainerType, values_callable=lambda enum_cls: [e.value for e in enum_cls]), nullable=False, index=True)
    status = db.Column(Enum(ContainerStatus, values_callable=lambda enum_cls: [e.value for e in enum_cls]), default=ContainerStatus.EMPTY, nullable=False, index=True)
