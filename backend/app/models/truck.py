...
class Truck(db.Model):
    ...
    truck_type = db.Column(Enum(TruckType), nullable=False, index=True)
    status = db.Column(Enum(TruckStatus), default=TruckStatus.AVAILABLE, nullable=False, index=True)
