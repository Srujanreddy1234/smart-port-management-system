...
class Truck(db.Model):
    ...
    truck_type = db.Column(Enum(TruckType, values_callable=lambda enum_cls: [e.value for e in enum_cls]), nullable=False, index=True)
    status = db.Column(Enum(TruckStatus, values_callable=lambda enum_cls: [e.value for e in enum_cls]), default=TruckStatus.AVAILABLE, nullable=False, index=True)
